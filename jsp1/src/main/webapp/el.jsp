...
<html>
	...
	<body>
        ...
        <%-- 상태 저장 변수에 상태 저장 --%>
        <%
        pageContext.setAttribute("var1", 1); // pageContext에 정보 저장
        request.setAttribute("var2", "hello"); // request 객체에 var2라는 이름에 hello라고 설정
        
        Contact c = new Contact(1, "a", "b", "c");
        session.setAttribute("var2", c); // session 객체에 정보 저장
        %>
        ...
        <p>
            ...
            session.var2: ${sessionScope.var2}
        </p>
