...
<html>
	...
	<body>
        ...
        <p>
            ...
            <br/>
            c2.phone = <jsp:getProperty property="phone" name="c2"/>
        </p>
        ...
        <jsp:setProperty property="name" name="c2" value="홍"/>
        <p>
            c2.name = <jsp:getProperty property="name" name="c2"/>
        </p>
        
        <%
        Contact c3 = new Contact(1, "오쌤", "01000000000", "ㅇㅇ@itwill.com");
        %>
        <jsp:useBean id="c4" class="com.itwill.jsp1.model.Contact">
            <jsp:setProperty name="c4" property="id" value="4"/>    
            <jsp:setProperty name="c4" property="name" value="홍"/> 
            <jsp:setProperty name="c4" property="phone" value="010"/> 
            <jsp:setProperty name="c4" property="email" value="@itwill"/>         
        </jsp:useBean>
        <p>
