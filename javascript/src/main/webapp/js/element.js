...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // id로 HTML 요소(element)를 찾음:
    const btn1 = document.getElementById('btn1');
    
    // 찾은 HTML 요소에 'click' 이벤트 리스너를 등록: 
    // addEventListenet('eventName', callback);
    ...
    // CSS selector(선택자) 문법을 argument로 사용하는 매서드:
    // tagName, .classNAme, #id, tagName.className#id
    // parent descendent: 자손 요소 찾기
    // parent > child: 자식 요소 찾기
    // element: pseudo-selector: (예) button:hover, tr:nth-child(odd)
