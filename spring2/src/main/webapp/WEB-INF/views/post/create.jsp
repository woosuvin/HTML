...
<html>
	...
	<div class="container-fluid">
        ...
        <main class="my-2">
        <div class="card">
            <form method="post"> <%-- action 없으면 현재 페이지 (/post/create)로 이동 --%>
                <div class="card-body">
                    <div class="my-4">
                        <label for="title" class="form-label">제목</label> <%-- id=title의 label --%>
                        <input type="text" id="title" name="title" required autofocus class="form-control"/> <%-- name = request parameter --%>
                    </div>
                    <div class="my-4">
                ...
                <div class="card-footer">
                        <input type="submit" value="작성 완료" class="form-control"/>
                </div>
            </form>        
        </div>
        </main>
