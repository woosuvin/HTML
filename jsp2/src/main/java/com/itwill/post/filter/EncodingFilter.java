...
public class EncodingFilter extends HttpFilter implements Filter { // HttpFilter 클래스 상속 Filter 인터페이스 구현
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) 
        ...
        // 클라이언트에서 온 요청을 controller(servlet)에게 전달하기 전에 실행할 코드들을 작성.
