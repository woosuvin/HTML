...
public class PostUpdateController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
	    ...
	    // 요청 파라미터 값들(id, title, content)을 찾음.
	    long id = Long.parseLong(request.getParameter("id")); // modify.jsp에서 name="id"
	    String title = request.getParameter("title"); //  modify.jsp에서 name="title"
	    String content = request.getParameter("content"); // modify.jsp에서 name="content"
