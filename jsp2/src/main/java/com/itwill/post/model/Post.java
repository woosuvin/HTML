...
// MVC 아키텍쳐에서 model에 해당하는 클래스 - 데이터베이스 테이블과 테이블에 매핑되는 클래스.
...
public class Post {
    ...
    public Post(long id, String title, String content, String author, LocalDateTime createdTime, LocalDateTime modifiedTime) {
        this.id = id;
        this.title = title;
